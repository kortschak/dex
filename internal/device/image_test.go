...
var writeTests = []struct {
	...
	{
		name: "svg_file",
		data: "data:text/filename,dot.svg",
		typ:  "image_file",
	},
	{
		name: "svg_file_title",
		data: "data:text/filename;title=RED DOT;dy=0.1,dot.svg",
		typ:  "image_file",
	},
	{
		name: "svg_file_gamma",
		data: "data:text/filename;color_space=gamma;gamma=5,dot.svg",
		typ:  "image_file",
	},
	{
		name: "svg_file_title_gamma",
		data: "data:text/filename;title=RED DOT;dy=0.1;color_space=gamma;gamma=5,dot.svg",
		typ:  "image_file",
	},
	{
	...
	{
		name: "svg_image",
		data: `data:image/*;svg,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><circle cx="100" cy="100" r="90" stroke="black" stroke-width="5" fill="red"/></svg>`,
		typ:  "image",
	},
	{
		name: "svg_image_title",
		data: `data:image/*;title=RED DOT;svg,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><circle cx="100" cy="100" r="90" stroke="black" stroke-width="5" fill="red"/></svg>`,
		typ:  "image",
	},
	{
		name: "svg_image_gamma",
		data: `data:image/*;color_space=gamma;gamma=5;svg,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><circle cx="100" cy="100" r="90" stroke="black" stroke-width="5" fill="red"/></svg>`,
		typ:  "image",
	},
	{
		name: "svg_image_title_gamma",
		data: `data:image/*;color_space=gamma;gamma=5;title=RED DOT;svg,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"><circle cx="100" cy="100" r="90" stroke="black" stroke-width="5" fill="red"/></svg>`,
		typ:  "image",
	},
	{
